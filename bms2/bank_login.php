...
if (isset($_POST['login'])) {
    ...
    $stmt_login = $conn->prepare("SELECT employee.bank_id, employee.bank_password, bank_details.bank_name FROM employee JOIN bank_details ON employee.bank_id = bank_details.bank_id WHERE employee.employee_id = ?");
